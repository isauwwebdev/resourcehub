        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              Complete all the tasks below and unlock your journey!
            </p>
          </div>
            ...
            <div className="mb-6">
              <div className="flex items-center mb-4">
                ...
                <div className="flex flex-col p-2 bg-neutral rounded-box text-neutral-content text-yellow sm:text-2xl">
                  <span
                    className="bg-gradient-to-r from-red-800 to-orange-500 text-transparent 
                          bg-clip-text font-semibold mx-auto"
                  >
                    Happening Now
                  </span>
                </div>
                <span className="ml-auto text-2xl font-semibold text-gray-900">
                  {progress}%
                </span>
              </div>
